                    ...
                    >
                      ...
                      >
                        ...
                        {/* <AnimatePresence mode="sync">
                          <motion.img
                            key={ele?.id}
                            src={`${ele?.still_path !== null && ele?.still_path !== undefined ? process.env.NEXT_PUBLIC_TMBD_IMAGE_URL + ele?.still_path : "/images/logolmg.svg"}`}
                            initial={{ opacity: 0 }}
                            animate={{
                        ...
                        <LazyLoadImage
                          key={ele?.id}
                          src={`${imagePlaceholder ? "/images/logolmg.svg" : ele?.still_path !== null && ele?.still_path !== undefined ? process.env.NEXT_PUBLIC_TMBD_IMAGE_URL + ele?.still_path : "/images/logolmg.svg"}`}
                          height="100%"
                          width="100%"
        ...
        <div className={styles.categoryDetails}>
          {category === "overview" && type !== "person" && (
            <>
              ...
              {type === "tv" && (
                <>
                  <h3>Mostrar Detalhes</h3>
                  {data?.status && <p> Status : {data?.status}</p>}
                  {data?.number_of_seasons && (
                    <p> Total de Temporadas : {data?.number_of_seasons}</p>
                  )}
                  {data?.number_of_episodes && (
                    <p> Total de Episódios : {data?.number_of_episodes}</p>
                  )}
          ...
          <div className={styles.casts}>
            {category === "casts" && (
              <>
                <h4 className={styles.header}>Elenco</h4>
                    ...
                    >
                      ...
                      >
                        ...
                        {/* <AnimatePresence mode="sync">
                          <motion.img
                            key={ele?.id}
                            src={`${ele?.profile_path !== null && ele?.profile_path !== undefined ? process.env.NEXT_PUBLIC_TMBD_IMAGE_URL + ele?.profile_path : "/images/logolmg.svg"}`}
                            initial={{ opacity: 0 }}
                            animate={{
                              opacity: imageLoading ? 0 : 1,
                            }}
                        ...
                        <LazyLoadImage
                          key={ele?.id}
                          src={`${imagePlaceholder ? "/images/logolmg.svg" : ele?.profile_path !== null && ele?.profile_path !== undefined ? process.env.NEXT_PUBLIC_TMBD_IMAGE_URL + ele?.profile_path : "/images/logolmg.svg"}`}
                          height="100%"
                          width="100%"
                          useIntersectionObserver={true}
                          effect="opacity"
